...
const DeleteConfirmationDialog = ({ open, onClose, onConfirm, program, loading }) => {
    ...
    >
      ...
      <DialogContent sx={{ pb: 2 }}>
        ...
        <Typography variant="body1" sx={{ mt: 2, color: theme.palette.text.secondary }}>
          {t('deleteConfirmation')} {t('program')} {t('deleteConfirmationEnd')}
        </Typography>
      </DialogContent>
